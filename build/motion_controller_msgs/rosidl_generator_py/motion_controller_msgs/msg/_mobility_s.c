...
bool motion_controller_msgs__msg__mobility__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motion_controller_msgs.msg._mobility.Mobility", full_classname_dest, 45) == 0);
  }
  motion_controller_msgs__msg__Mobility * ros_message = _ros_message;
  {  // front_right
...
{
  /* NOTE(esteve): Call constructor of Mobility */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("motion_controller_msgs.msg._mobility");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Mobility");

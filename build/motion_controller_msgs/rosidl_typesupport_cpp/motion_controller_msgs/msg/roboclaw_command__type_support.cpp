...
static const _RoboclawCommand_type_support_symbol_names_t _RoboclawCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motion_controller_msgs, msg, RoboclawCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motion_controller_msgs, msg, RoboclawCommand)),
  }
};
...
{
  return &::motion_controller_msgs::msg::rosidl_typesupport_cpp::RoboclawCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motion_controller_msgs, msg, RoboclawCommand)() {
  return get_message_type_support_handle<motion_controller_msgs::msg::RoboclawCommand>();
}
